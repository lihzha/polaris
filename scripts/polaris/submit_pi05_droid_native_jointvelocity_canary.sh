...
export_vars="ALL,NFS_ROOT=${NFS_ROOT},POLARIS_DIR=${POLARIS_DIR},EXPECTED_POLARIS_COMMIT=${POLARIS_COMMIT},RUN_DIR=${RUN_DIR},POLARIS_PYXIS_IMAGE=${POLARIS_PYXIS_IMAGE},POLARIS_DATA_DIR=${POLARIS_DATA_DIR},HOST_FFPROBE_PATH=${HOST_FFPROBE_PATH},EXPECTED_HOST_FFPROBE_SHA256=${EXPECTED_HOST_FFPROBE_SHA256},HOST_FFMPEG_PATH=${HOST_FFMPEG_PATH},EXPECTED_HOST_FFMPEG_SHA256=${EXPECTED_HOST_FFMPEG_SHA256},EXPECTED_HOST_MEDIA_TOOLS_MANIFEST_SHA256=${EXPECTED_HOST_MEDIA_TOOLS_MANIFEST_SHA256},CONTROLLER_COMPLETION=${CONTROLLER_COMPLETION},EXPECTED_CONTROLLER_COMPLETION_SHA256=${EXPECTED_CONTROLLER_COMPLETION_SHA256},ALL_SIX_CONTROLLER_COMPLETION=${ALL_SIX_CONTROLLER_COMPLETION},EXPECTED_ALL_SIX_COMPLETION_SHA256=${EXPECTED_ALL_SIX_COMPLETION_SHA256},EXPECTED_ALL_SIX_PROFILE=${EXPECTED_ALL_SIX_PROFILE}"
...
publish_immutable_json(
    Path(os.environ["SUBMISSION_RECORD"]),
    {
        ...
        "expected_host_media_tools_manifest_sha256": os.environ[
            "EXPECTED_HOST_MEDIA_TOOLS_MANIFEST_SHA256"
        ],
        "host_ffprobe_path": os.environ["HOST_FFPROBE_PATH"],
        "expected_host_ffprobe_sha256": os.environ["EXPECTED_HOST_FFPROBE_SHA256"],
        "host_ffmpeg_path": os.environ["HOST_FFMPEG_PATH"],
        "expected_host_ffmpeg_sha256": os.environ["EXPECTED_HOST_FFMPEG_SHA256"],
